...
def try_methods_and_functions():
    ...
    ####################################################################
    jon = rg.SimpleTurtle()
    jon.pen = rg.Pen('blue', 5)

    jon.backward(150)

    jon.speed = 1
    draw_many_squares(jon, 2, 100, 30)

    jon.speed = 5
    jon.pen = rg.Pen('red', 5)
    draw_many_squares(jon, 10, 50, 15)

    jon.speed = 100
    jon.pen = rg.Pen('red', 35)
    draw_many_squares(jon, 8, 300, 60)

    jon.pen = rg.Pen('black', 3)
