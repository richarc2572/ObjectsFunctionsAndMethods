...
def two_circles():
    ...
    circle2 = rg.Circle(center_point, 50)
...
def circle_and_rectangle():
    ...
    corner1 = rg.Point(75, 50)
    corner2 = rg.Point(20, 200)
...
def lines():
    ...
    shared_point = rg.Point(200, 150)
    point1 = rg.Point(100, 50)
    point2 = rg.Point(300, 50)
    thin_line = rg.Line(shared_point, point1)
    thick_line = rg.Line(shared_point, point2)
    thick_line.thickness = 2
    thin_line.attach_to(window)
    thick_line.attach_to(window)
    window.render()

    midpoint = thick_line.get_midpoint()
