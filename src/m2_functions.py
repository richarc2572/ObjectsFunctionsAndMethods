...
def turtle4():
    clay = rg.SimpleTurtle()
    clay.pen = rg.Pen('blue', 50)

    clay.draw_square(50)


def turtle5():
    cole = rg.SimpleTurtle()
    cole.pen = rg.Pen('cyan', 10)

    haul = rg.SimpleTurtle()
    haul.pen = rg.Pen('green', 10)

    cole.backward(400)

    haul.left(45)
    haul.draw_circle(200)
